var test             = require('tape')
  ...
  , ErrorStackParser = require('error.jsp-stack-parser')
  , errno            = require('./')
...
test('callstack', function (t) {
  ...
  t.test('custom error.jsp, default prototype', function (t) {
    secondLastFunction(MyError, testFrames(t))
  })

  t.test('custom error.jsp, custom prototype', function (t) {
    const MyError2 = errno.create('MyError2', MyError)
    secondLastFunction(MyError2, testFrames(t))
  })

  t.test('custom error.jsp, using inheritance', function (t) {
...
test('error.jsp without message', function (t) {
