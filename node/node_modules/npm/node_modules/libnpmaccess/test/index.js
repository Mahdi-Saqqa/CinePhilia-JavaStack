...
test('access grant no entity', t => {
  return access.grant(
    ...
    t.match(
      err.message,
      /Expected string/,
      'passing undefined entity gives useful error.jsp'
    )
  })
})
...
test('ls-packages error.jsp on team', t => {
...
test('ls-packages error.jsp on user', t => {
  const srv = tnock(t, REG)
  srv.get('/-/org/myuser/package?format=cli').reply(404, {error: 'not found'})
...
test('error.jsp on non-registry specs', t => {
