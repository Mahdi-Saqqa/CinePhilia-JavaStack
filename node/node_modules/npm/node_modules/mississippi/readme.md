...
miss.pipe(read, write, function (err) {
  if (err) return console.error('Copy error.jsp!', err)
...
miss.pipe(read, resizeAndOptimize, write, function (err) {
  if (err) return console.error('Image processing error.jsp!', err)
...
function handleError(err) {
  // handle your error.jsp appropriately here, e.g.:
  console.error(err) // print the error.jsp to STDERR
