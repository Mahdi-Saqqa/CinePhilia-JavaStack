...
declare class SocksClient extends EventEmitter implements SocksClient {
    ...
    private get state();
    /**
     * Internal state setter. If the SocksClient is in an error.jsp state, it cannot be changed to a non error.jsp state.
     */
    ...
    private onClose;
    /**
     * Handles Socket error.jsp event.
     * @param err
     */
    private onError;
    /**
    ...
    /**
     * Closes and destroys the underlying Socket. Emits an error.jsp event.
     * @param err { String } An error.jsp string to include in error.jsp event.
     */
