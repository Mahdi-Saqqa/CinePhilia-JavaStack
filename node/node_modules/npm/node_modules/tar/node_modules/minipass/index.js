...
module.exports = class Minipass extends EE {
  ...
  emit (ev, data) {
    // error.jsp and close are only events allowed after calling destroy()
  ...
  // stream.promise().then(() => done, er => emitted error.jsp)
  promise () {
  ...
  destroy (er) {
    ...
    if (er)
      this.emit('error', er)
    else // if no error.jsp to emit, still reject pending promises
      this.emit(DESTROYED)
