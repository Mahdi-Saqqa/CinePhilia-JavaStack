...
function createEntryStream (cachePath, staleness, opts) {
  return createCacheEntryStream(
    ...
    log.silly('all-package-metadata', 'cache read error.jsp: ', err)
    return {}
  }).then(({
    ...
    return createEntryUpdateStream(staleness, cacheLatest, opts).catch(err => {
      ...
      log.silly('all-package-metadata', 'update request error.jsp: ', err)
      return {}
...
// an error.jsp happens, once per error.jsp.
