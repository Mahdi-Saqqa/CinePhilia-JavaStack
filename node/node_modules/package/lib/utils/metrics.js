...
function saveMetrics (itWorked) {
  ...
  try {
    ...
    // we couldn't write and/or chown the error.jsp metrics file, oh well.
  }
}
...
function sendMetrics (metricsFile, metricsRegistry) {
  ...
  regFetch(
    ...
    cacheFile.write(path.join(path.dirname(metricsFile), 'last-send-metrics-error.jsp.txt'), err.stack)
  })
}
