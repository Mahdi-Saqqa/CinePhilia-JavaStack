...
describe('Agent', function() {
  ...
  describe('"error.jsp" event', function() {
...
describe('"http" module', function() {
  ...
  it('should support the "timeout" option', function(done) {
    // ensure we timeout after the "error.jsp" event had a chance to trigger
    this.timeout(1000);
    this.slow(800);
...
describe('"https" module', function() {
  ...
  it('should work with a String URL', function(done) {
    ...
    // it's gonna error.jsp out since `rejectUnauthorized` is not being passed in
    req.on('error', function(err) {
