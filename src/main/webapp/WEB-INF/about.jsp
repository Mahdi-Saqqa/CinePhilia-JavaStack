        ...
        <div class="col col-sm-9 col-xl-11 px-sm-10 px-12 sticky-top ">
            <main class="row overflow-auto canvas">
                <div class="col d-flex flex-column align-self-center">
                    <div class="d-flex justify-content-center align-content-center text-center flex-column w-75 mx-auto">
                        <img src="/img/Logo.png" class="col-2 mx-auto mt-5">
                        <h1 class="h1 my-2">About Us</h1>
