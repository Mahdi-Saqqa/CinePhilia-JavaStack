...
<script type="text/javascript">
    $(document).ready(function() {
        $("#search-box").on("keydown", function() {
            ...
            console.log(query);
            $.ajax({
                url: "https://api.themoviedb.org/3/search/movie?api_key=936ec287a61d8548efeb41653e17f492&include_adult=false&language=en-US&page=1&query="+query,
                method: "GET",
                success: function(data) {
                    ...
                    for (var i = 0; i < results.length; i++) {
                        ...
                        var moviePoster = movie["backdrop_path"];
