...
<div class="container-fluid overflow-hidden">
    <div class="row overflow-auto">
        ...
        <div class="col d-flex flex-column align-self-center">
            ...
            <h1>Add Movie <c:out value="${currentUser.username}"></c:out></h1>

            <form method="POST" action="/admin/newmovie">
                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                <select class="form-select w-25" aria-label="Default select example" name="movieId" >
                    <option selected>select a movie</option>
                    <option value="1">One</option>
                    <option value="2">Two</option>
                    <option value="3">Three</option>
                </select>
                <input class="m-2 p-2" style="background-color: slateblue " type="submit" value="Add"/>
            </form>
            </div>
    </div>
</div>
