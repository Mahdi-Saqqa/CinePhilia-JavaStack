...
<body class="bg-dark">
    <div class="col-3 m-auto">
        <form style="-webkit-box-shadow: 0px 0px 15px -3px rgba(255,255,255,1); -moz-box-shadow: 0px 0px 15px -3px rgba(255,255,255,1); box-shadow: 0px 0px 15px -3px rgba(255,255,255,1);" class="form" action="login" method="post">
            ...
            <p id="" class="h-3 text-light text-center">Login</p>
            <div class="field">
                ...
                <input autocomplete="off" placeholder="Username" class="input-field" id="username" name="username" type="text" required>
            </div>
            <div class="field">
                <svg class="input-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
            ...
            <div class="btn">
                ...
                <a href="/register" class="button2">Sign Up</a>
            </div>
